        ...
        <div className="row align-items-center">
          ...
          <div className="card">
            <div className="funfact-content funfact-res text-left px-5 mx-5">
              ...
              It's proven that the right supplementation will help you get a good night's sleep. LYMA's ingredients are proven to work: patented and backed by peer-reviewed evidence. Our Natural Engineering methods will give you the advantage to feel 100% human again.</p>
                {/* <div className="ptag">
