...
<div className="col-lg-6 col-md-6 col-sm-12  p-3">
  ...
  <div className="col-lg-6 col-md-6 col-sm-12  p-3">
  <div className="container-fluid">
  <div class = "shadow mb-5 bg-white" style={{borderLeft: "10px solid #527991", padding: "38px", height: "400px"}}>  
    <div className="row align-items-center justify-content-center">
      <div className="col-md-8 col-lg-6 order-2 order-lg-1">
        <div className="funfact-content funfact-res text-left">
  ...
  <div className="col-lg-6 col-md-6 col-sm-12 p-3">
  <div className="container-fluid">
  <div class = "shadow mb-5 bg-white" style={{borderLeft: "10px solid #d11388", padding: "27px", height: "400px"}}>  
